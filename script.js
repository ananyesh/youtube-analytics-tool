                    ...
                    if (matches) {
                        ...
                        if (rawLogo) {
                            ...
                            if (!foundLogos.has(cleanLogo)) {
                                ...
                                // FIX: Use Wayback's own image proxy (im_) to bypass CORS and loading issues
        ...
        growthChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    borderWidth: 3,
                    pointRadius: processedStats.length > 50 ? 0 : 3,
                    pointHoverRadius: 6,
                    fill: true,
